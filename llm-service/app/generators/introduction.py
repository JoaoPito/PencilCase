...
It should have at most 1 paragraph and should cover the basic aspects of '{topic}' and nothing else.
IF the student asks for something that is not a valid topic write the message "TOPIC NOT VALID".
WRITE ONLY THE INTRODUCTION AND NOTHING ELSE. DO NOT WRITE ANY TITLES STARTING WITH '#'. ALWAYS WRITE SOMETHING. ALWAYS WRITE IN THE STUDENT'S LANGUAGE.
